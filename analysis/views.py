...
def display_pivot_tables(request):
    ...
    return render(request, 'analysis/results.html', {'total_doc_num_count': total_doc_num_count, 'total_customers': total_customers, 'total_quantity': total_quantity, 'results1': results1})
